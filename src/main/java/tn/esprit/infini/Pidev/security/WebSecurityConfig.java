...
import tn.esprit.infini.Pidev.Service.user_management.UserDetailsServiceImpl;
        ...
        protected void configure(HttpSecurity http) throws Exception {
            http.cors().and().csrf().disable()
                    ...
                    .authorizeRequests().antMatchers("/api/auth/**","/Credit/CalculMensualite0fixe",
                            ...
                            "/Invest/taxes","/Produit/afficher","/Produit/addproduit","/Produit/modifier","/Produit/delete").permitAll()
