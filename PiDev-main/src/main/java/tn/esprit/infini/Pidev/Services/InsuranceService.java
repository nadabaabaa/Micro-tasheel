    ...
    public Insurance addInsurance(Insurance i) {
        ...
        public double calculateInsuranceCost(Insurance insurance) {
            ...
            double riskFactor = calculateFicoScore(insurance);
       ...
       /* @Override
        ...
        public boolean processInsuranceRequest(Insurance insurance) {
            ...
            @Override
            public void ValidateInsurance(Insurance insurance){
      ...
      /*  @Override
        ...
        @Override
        public double LevelOfRiskCalculator(Insurance insurance) {
        ...
        @Override
        public Insurance addInsuranceAndAssignToPack(Insurance insurance, int idPack) {

            Pack b=packRepository.findByIdPack(idPack);
            Insurance a=insuranceRepository.save(insurance);
            a.setPack(b);
            return insurance;
        }
